 <?php /* Grid of 5 Articles */
   ...
   $cb_cpt_output = cb_get_custom_post_types( $cb_taxonomy );
    if ( is_home() ) {
        ...
        $cb_qry = new WP_Query( array( 'posts_per_page' => 5, 'cat' => $cb_cat_id, 'tag__in' => $cb_tag_id, 'post__in' => $cb_post_ids, 'no_found_rows' => true, 'post_type' => $cb_cpt_output, 'post_status' => 'publish', 'ignore_sticky_posts' => true, 'offset' => $cb_offset, 'order' => $cb_order, 'orderby' => $cb_orderby,  'tax_query' => $cb_tax_qry ) );
    }
